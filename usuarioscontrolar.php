...
<tr><th>Nome</th><th>Email</th><th>Telefone</th><th>Acesso</th><th colspan="3">Ações</td></tr>
	...
	<?php
	  while($row = $result->fetch_assoc()) {
		...
		echo "<td><a href='usuarioeditarform.php?id=" . $row["id"] . "'><img src='./imagens/editar1.png' alt='Editar Usuário'></a></td><td><a href='usuariobloquear.php?id=2&status='ativo'" . $row["id"] .  "'><img src='./imagens/bloquear1.png' alt='Bloquear Usuário'></a></td><td><a href='usuarioexcluir.php?id=" . $row["id"] . "'><img src='./imagens/excluir1.png' alt='Excluir Usuário'></a></td></tr>";
	  }
	?>
