...
<th>Excluir Serviço</th>
	...
	<?php
	  ...
	  while($row = $result->fetch_assoc()) {
					...
					echo "<td><a href='minhaareaexcluir.php?id=" . $row["id"] . "'><img src='./imagens/excluir1.png' alt='Excluir Usuário'></a></td></tr>";
...
<table>
	  ...
	  while($row2 = $result2->fetch_assoc()) {
					...
					<td>" . $row2["nome"] . "</td>
					<td>
					<a href='profissionalcontrolar.php?servico=" . $row2["id"] . "'>" . $row2["data"] . "</td>
					<td>" . $row2["hora"] . "</td>
					<td>" . $row2["servico"] . "</td>";
					echo "<td><a href='agendamentoexcluir.php?id=" . $row2['id'] . "'><img src='./imagens/excluir1.png' alt='Excluir Usuário'></a></td></tr>";
